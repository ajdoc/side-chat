    ...
    public function all(): array
    {
        return [
            ...
            self::ROLE_ASSIGNED => [
                ...
                'fields' => ['user_id', 'user_name', 'role', 'previous_role'],
            ],
            self::MESSAGE_CREATED => [
                'label' => 'Message sent',
                'description' => 'Somebody posted in a channel this server can see. Never fires for a bot’s own message.',
                'fields' => ['user_id', 'user_name', 'channel_id', 'channel_name', 'message_id', 'body'],
            ],
            self::REACTION_ADDED => [
                'label' => 'Reaction added',
                'description' => 'Somebody reacted to a message.',
                'fields' => ['user_id', 'user_name', 'channel_id', 'message_id', 'emoji', 'message_author_id'],
            ],
            ...
            self::COMMAND_INVOKED => [
                ...
                'fields' => ['user_id', 'user_name', 'channel_id', 'command', 'args'],
            ],
            self::SCHEDULE_DUE => [
            ...
            self::BADGE_GRANTED => [
                ...
                'fields' => ['user_id', 'user_name', 'badge_id', 'badge_name'],
            ],
        ];
    }
