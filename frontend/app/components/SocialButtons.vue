...
<template>
  <div class="grid gap-3">
    <Button type="button" variant="outline" class="w-full" @click="go('google')">
    ...
    <Button type="button" variant="outline" class="w-full" @click="go('facebook')">
      <svg class="mr-2 h-4 w-4" viewBox="0 0 24 24" fill="#1877F2" aria-hidden="true">
